...
function App() {
  const lignes = [
    ...
    { id: 7,  numero: "26", depart: "Fann",                arrivee: "HLM",         arrets: 9,  couleur: "#d35400" },
    { id: 8,  numero: "31", depart: "Liberte 6",           arrivee: "Dieuppeul",   arrets: 13, couleur: "#c0392b" },
    { id: 9,  numero: "42", depart: "Sicap Mbao",          arrivee: "Medina",      arrets: 15, couleur: "#1abc9c" },
    { id: 10, numero: "55", depart: "HLM",                 arrivee: "Rufisque",    arrets: 20, couleur: "#2c3e50" },
  ];
  return (
    <div className="App">
      <Header />
